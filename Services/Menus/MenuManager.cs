...
#pragma warning restore CS1591
    ...
    public sealed class MenuManager : IDraw, IUpdate, IVisible
    {
        ...
        private Panel? _backgroundItems;
        ...
        private bool _keyboardUsedInThisFrame;
        private bool _mouseHasMovedSinceLastKeyboard;
                                 ...
                                 bool resize = false)
        {
            ...
            if (_backgroundItems != null)
            {
                ...
                if (_direction == MenuItemDirection.Vertical)
                {
                    ...
                    _backgroundItems.Dimensions += new Vector2(totalOffset, 0);
                    _backgroundItems.Position -= new Vector2(leftIconOffset, 0);
                }
                else if (_direction == MenuItemDirection.Horizontal)
                {
                    ...
                    _backgroundItems.Dimensions += new Vector2(0, totalOffset);
                    _backgroundItems.Position -= new Vector2(leftIconOffset, 0);
                }
            }
        }
        ...
        {
            //bool bkgnotexist = (_backgroundItems == null);
            _backgroundItems = panel;
            ...
            _backgroundItems.ZOrder = min_zorder - 1;
        ...
        {
            _backgroundItems?.SetVisible(visible);
        }
        ...
        public void Draw(SpriteBatch spritebatch)
        {
            ...
            _backgroundItems?.Draw(spritebatch);
        ...
        public void Update(GameTime gametime)
        {
            ...
            _keyboardUsedInThisFrame = false;
        }
        ...
        private void HandleMouseInput()
        {
            ...
            bool mousePositionChanged = ms.Position != _oldMouseState.Position;
            ...
            if (menuItemsGroupRect.Contains(mousePos))
            {
                foreach (MenuItem item in _items)
                {
                    ...
                    if (item.State != MenuItemState.Disable && itemRect.Contains(mousePos))
                    {
                        hoveredItem = item;
                        break;
                    }
            ...
            if (!_keyboardUsedInThisFrame && _mouseHasMovedSinceLastKeyboard)
            {
            ...
            if (CurrentItem != null && CurrentItem == hoveredItem && clicked)
            {
        ...
        private void HandleKeyInput()
        {
            ...
            {
                _keyboardUsedInThisFrame = true;
                _mouseHasMovedSinceLastKeyboard = false;
            }
        }
